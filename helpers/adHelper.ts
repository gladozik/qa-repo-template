...
export async function createAd(request: APIRequestContext, token: string, dto: CreateAdDto) {
...
export async function createAds(api: APIRequestContext, token: string, dtos: CreateAdDto[]) {
    const created: any[] = [];
